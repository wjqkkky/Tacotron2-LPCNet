...
def train(log_dir, args, hparams):
    ...
    print(input_path)
   # input_path = '/data1/jiangpeipei/begeekmyfriend/LPCTron/spanish_Lpcnet/Tacotron-2-BIaoBei/training_data/'
            ...
            while not coord.should_stop() and step < args.tacotron_train_steps:
                ...
                if step % args.eval_interval == 0:
                    ...
                    plot.plot_alignment(align, os.path.join(eval_plot_dir, 'step-{}-eval-align.png'.format(step)),
                        title='{}, {}, step={}, loss={:.5f}'.format(args.model, time_string(), step, eval_loss), max_len=t_len//hparams.outputs_per_step)
