...
class Feeder:
    ...
    def __init__(self, coordinator, metadata_filename, hparams):
       ...
       # medata_filename = '/data1/jiangpeipei/begeekmyfriend/LPCTron/spanish_Lpcnet/Tacotron-2-BIaoBei/training_data'
    ...
    def _get_test_groups(self):
        ...
        mel_target = np.fromfile(os.path.join(self._audio_dir, meta[0].replace('audio-','').replace('/mels/','/audio/').replace('.npy','.wav.s16.f32')), dtype='float32')
